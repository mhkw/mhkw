...
export default class Search extends React.Component {
    ...
    componentDidMount() {
        ...
        this.setState({ height: document.documentElement.clientHeight - document.querySelector('.top').offsetHeight})
    ...
    render() {
        return (
            <div className={"searchIpt"}>
                <div className="searchPD forgetNav top">
                ...
                <div style={{overflow:"auto",height:this.state.height}}>
