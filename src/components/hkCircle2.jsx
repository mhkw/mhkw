...
export default class LoginView extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            // res: [],
            res: sessionStorage.getItem("resdata") ? dataSource.cloneWithRows(JSON.parse(sessionStorage.getItem("resdata")))._dataBlob.s1 : [],
            love_list:[],
            placeholderWords:"留言：",
            commentToId:"",        //发帖人id
            commentId:"",         //文章id
            ...
            <div className="homeWrap">
                <div className="lanternLis">
                    ...
                    <div className="fourAvt">
                        <ul>
                            <li onClick={() => { hashHistory.push({ pathname: '/postBar' }) }}>
                                <Link>
